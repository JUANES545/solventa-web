...
export class LocalizedTitleStrategy extends TitleStrategy {
  ...
  private readonly keys: Record<string, string> = {
    ...
    'Solventa · Advisor dashboard': 'advisor.dashboard.title',
    'Solventa · Advisor clients': 'advisor.clients.title',
    'Solventa · Advisor client': 'advisor.clients.record',
    'Solventa · Assisted quote': 'advisor.quote.title',
    'Solventa · Assisted quotes': 'advisor.quotes.title',
